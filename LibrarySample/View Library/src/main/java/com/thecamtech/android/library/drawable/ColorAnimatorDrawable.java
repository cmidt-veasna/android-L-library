 ...
 */
public class ColorAnimatorDrawable extends Drawable {
     ...
     */
    public ColorAnimatorDrawable(int color) {
        this(null);
        setColor(color);
    }

    private ColorAnimatorDrawable(ColorState state) {
    ...
    final static class ColorState extends ConstantState {
        ...
        public Drawable newDrawable() {
            return new ColorAnimatorDrawable(this);
        }
